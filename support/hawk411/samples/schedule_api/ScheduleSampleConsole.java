...
/**
 * ScheduleSampleConsole is a simple console that keep track of rulebase engine
 * on a given agent.  It is used by the schedule API
 * samples to demonstrate how a console application interact with an agent.
 */
class ScheduleSampleConsole implements ScheduleSampleConstant,
	AgentMonitorListener, MicroAgentListMonitorListener, ErrorExceptionListener
{
	 ...
	 */
	public ScheduleSampleConsole(String args[])
	{
     ...
     *                  See the TIBCO Rendezvous documentation for more information.
     */
	public ScheduleSampleConsole(String agentName, String hawkDomain, String rvService, String rvNetwork, String rvDaemon)
	{
		create(agentName, hawkDomain, rvService, rvNetwork, rvDaemon);
	}
