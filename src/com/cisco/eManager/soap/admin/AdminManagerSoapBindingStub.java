/**
 * AdminManagerSoapBindingStub.java
 *
...
public class AdminManagerSoapBindingStub extends org.apache.axis.client.Stub implements com.cisco.eManager.soap.admin.AdminManager {
    ...
    static {
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "in2"), new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("updateUserTimeoutSession");
        oper.addParameter(new javax.xml.namespace.QName("", "in0"), new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
    ...
    public AdminManagerSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AdminManagerSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AdminManagerSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void createUserAccount(java.lang.String in0, java.lang.String in1, java.lang.String in2, java.lang.String in3) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("createUserAccount");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "createUserAccount"));
    ...
    public void deleteUserAccount(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("deleteUserAccount");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "deleteUserAccount"));
    ...
    public java.lang.String login(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "login"));
    ...
    public void logout(java.lang.String in0) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "logout"));
    ...
    public void resetUserPassword(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("resetUserPassword");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "resetUserPassword"));
    ...
    public void updateUserPassword(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "updateUserPassword"));
    ...
    public void updateUserTimeoutSession(java.lang.String in0, long in1) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("updateUserTimeoutSession");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://admin.soap.eManager.cisco.com", "updateUserTimeoutSession"));
