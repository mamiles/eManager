/**
 * EventManagerSoapBindingSkeleton.java
 *
...
public class EventManagerSoapBindingSkeleton implements com.cisco.eManager.soap.event.EventManager, org.apache.axis.wsdl.Skeleton {
    private com.cisco.eManager.soap.event.EventManager impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("http://event.soap.eManager.cisco.com", "xmlMessage"));
    ...
    public EventManagerSoapBindingSkeleton() {
        this.impl = new com.cisco.eManager.soap.event.EventManagerSoapBindingImpl();
    }

    public EventManagerSoapBindingSkeleton(com.cisco.eManager.soap.event.EventManager impl) {
        this.impl = impl;
    }
