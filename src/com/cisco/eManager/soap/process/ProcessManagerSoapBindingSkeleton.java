/**
 * ProcessManagerSoapBindingSkeleton.java
 *
...
public class ProcessManagerSoapBindingSkeleton implements com.cisco.eManager.soap.process.ProcessManager, org.apache.axis.wsdl.Skeleton {
    private com.cisco.eManager.soap.process.ProcessManager impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("http://process.soap.eManager.cisco.com", "xmlMessage"));
    ...
    public ProcessManagerSoapBindingSkeleton() {
        this.impl = new com.cisco.eManager.soap.process.ProcessManagerSoapBindingImpl();
    }

    public ProcessManagerSoapBindingSkeleton(com.cisco.eManager.soap.process.ProcessManager impl) {
        this.impl = impl;
    }
