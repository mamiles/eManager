...
public class CommandLine
{
    ...
    private static ProcessManagerInterface pmStub = null;
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            pmStub = (ProcessManagerInterface)Naming.lookup("//" + serverName + "/" + ProcessManagerInterface.LOOKUPNAME);
        }
        catch (RemoteException ex)
        {
            pw.println("There is a problem connecting to the eManager Server:");
            pw.println("RemoteException: " + ex);
            System.exit(EXIT_CONNECT);
        }
        catch (MalformedURLException ex)
        {
            pw.println("There is a problem connecting to the eManager Server:");
            pw.println("MalformedURLException: " + ex);
            System.exit(EXIT_CONNECT);
        }
        catch (NotBoundException ex)
        {
            pw.println("There is a problem connecting to the eManager Server:");
            pw.println("NotBoundException: " + ex);
            System.exit(EXIT_CONNECT);
        }
    ...
    private static void loginNBAPI()
    {
        ...
        try {
            mAccess = pmStub.login(mUserId, mPassword);
            if (mAccess == null) {
                pw.println("The Access Type for user " + mUserId + " is null");
                mAccess = AccessType.READ;
            }
        }
        catch (RemoteException ex)
        {
            pw.println("Error Calling eManager to get user id: " + ex);
            System.exit(EXIT_CONNECT);
        }
        catch (EmanagerAdminException e)
        {
            pw.println(e.getStatusCode().getStatusCodeDescription());
            System.exit(EXIT_CONNECT);
        }
        catch (Exception e)
        {
