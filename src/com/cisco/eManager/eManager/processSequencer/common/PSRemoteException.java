 ...
 */
public class PSRemoteException extends java.rmi.RemoteException implements java.io.Serializable {
     ...
     */
    public PSRemoteException(EnumeratedType msgKey) {
     ...
     *      bundle
     */
    public PSRemoteException(EnumeratedType msgKey, Object[] args) {
     ...
     */
    public PSRemoteException(EnumeratedType msgKey, Throwable e) {
     ...
     *      bundle
     */
    public PSRemoteException(EnumeratedType msgKey, Throwable e, Object[] args) {
     ...
     */
    public PSRemoteException(String reason) {
        super(reason);
     ...
     *@param  e       the exception to be nested
     */
    public PSRemoteException(String reason, Throwable e) {
        this(reason);
        m_nestedException = e;
        m_oldStyleException=true;
    }
     ...
     *@param  e  the exception to be nested
     */
    public PSRemoteException(Throwable e) {
        this("Unknown", e);
        m_oldStyleException=true;
    }
    ...
    /**
     *  Gets the formattedMessage attribute of the PSRemoteException object
     *
...
//==========================================================
    ...
    private void formatMessage(String bundle, Locale locale) {
        ...
        if (m_resourceBundle == null) {
            if (m_resourceBundleName != null && m_locale != null) {
                ...
                throw new RuntimeException("PSRemoteException::NULL Resource Bundle");
            }
        }
    ...
    /**
     *  Gets the stackTrace attribute of the PSRemoteException object
     *
