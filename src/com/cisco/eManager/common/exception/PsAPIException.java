...
/**
 * <p>Title: eManager Process Sequencer / Manager Exceptions </p>
 * <p>Description: </p>
 ...
 */
public class PsAPIException extends java.lang.RuntimeException {
     ...
     */
    public PsAPIException(EnumeratedType msgKey) {
     ...
     *      bundle
     */
    public PsAPIException(EnumeratedType msgKey, Object[] args) {
     ...
     */
    public PsAPIException(EnumeratedType msgKey, Throwable e) {
     ...
     *      bundle
     */
    public PsAPIException(EnumeratedType msgKey, Throwable e, Object[] args) {
     ...
     */
    public PsAPIException(String reason) {
        super(reason);
     ...
     *@param  e       the exception to be nested
     */
    public PsAPIException(String reason, Throwable e) {
        this(reason);
        m_nestedException = e;
        m_oldStyleException=true;
    }
     ...
     *@param  e  the exception to be nested
     */
    public PsAPIException(Throwable e) {
        this("Unknown", e);
        m_oldStyleException=true;
    }
