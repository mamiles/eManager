...
/**
 * Class PhysicalViewChangeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PhysicalViewChangeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PhysicalViewChangeDescriptor() {
        super();
        xmlName = "physicalViewChange";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PhysicalViewChange target = (PhysicalViewChange) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _moved
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cisco.eManager.common.inventory2.NodeMovedNotification.class, "_moved", "moved", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                PhysicalViewChange target = (PhysicalViewChange) object;
                return target.getMoved();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PhysicalViewChange target = (PhysicalViewChange) object;
                    target.setMoved( (com.cisco.eManager.common.inventory2.NodeMovedNotification) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.cisco.eManager.common.inventory2.NodeMovedNotification();
            }
        } );
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cisco.eManager.common.inventory2.PhysicalViewChangeDescriptor()
    ...
    {
        return com.cisco.eManager.common.inventory2.PhysicalViewChange.class;
