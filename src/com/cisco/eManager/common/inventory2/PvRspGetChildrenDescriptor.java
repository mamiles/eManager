...
/**
 * Class PvRspGetChildrenDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PvRspGetChildrenDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PvRspGetChildrenDescriptor() {
        super();
        xmlName = "pvRspGetChildren";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PvRspGetChildren target = (PvRspGetChildren) object;
        ...
        //-- _hostNodesList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cisco.eManager.common.inventory2.HostNode.class, "_hostNodesList", "hostNodes", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                PvRspGetChildren target = (PvRspGetChildren) object;
                return target.getHostNodes();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PvRspGetChildren target = (PvRspGetChildren) object;
                    target.addHostNodes( (com.cisco.eManager.common.inventory2.HostNode) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.cisco.eManager.common.inventory2.HostNode();
            }
        } );
        desc.setHandler(handler);
        desc.setMultivalued(true);
        ...
        //-- validation code for: _hostNodesList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(0);
        { //-- local scope
        }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cisco.eManager.common.inventory2.PvRspGetChildrenDescriptor()
    ...
    {
        return com.cisco.eManager.common.inventory2.PvRspGetChildren.class;
