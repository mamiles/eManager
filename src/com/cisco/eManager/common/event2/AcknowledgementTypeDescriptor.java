...
**/
public class AcknowledgementTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AcknowledgementTypeDescriptor() {
        super();
        xmlName = "AcknowledgementType";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                AcknowledgementType target = (AcknowledgementType) object;
        ...
        //-- _date
        desc = new XMLFieldDescriptorImpl(java.util.Date.class, "_date", "date", NodeType.Element);
        handler = (new XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
    ...
    } //-- com.cisco.eManager.common.event2.AcknowledgementTypeDescriptor()
    ...
    **/
    ...
    {
        return com.cisco.eManager.common.event2.AcknowledgementType.class;
