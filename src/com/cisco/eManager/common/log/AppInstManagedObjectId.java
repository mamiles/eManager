...
**/
public abstract class AppInstManagedObjectId implements java.io.Serializable {
    ...
    **/
    ...
    public AppInstManagedObjectId() {
        super();
    } //-- com.cisco.eManager.common.log.AppInstManagedObjectId()
