...
**/
public class AuditMgrRespDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AuditMgrRespDescriptor() {
        ...
        desc = new XMLFieldDescriptorImpl(AuditLogEntries.class, "_auditLogEntriesList", "auditLogEntries", NodeType.Element);
    ...
    **/
    ...
    {
        return com.cisco.eManager.common.audit2.AuditMgrResp.class;
