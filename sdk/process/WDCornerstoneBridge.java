...
/**
 * <p> This class wraps a server to allow remote clients to spawn
 * autodiscovery <p>
 * @author     pmadden
 * @created    November 8, 2002
 */
public class WDCornerstoneBridge extends ProcessExecutor
{
  /**
   *  Constructor for the WDCornerstoneBridge object
   *
   * @param  name  Name of wrapped server
   */
  public WDCornerstoneBridge(String name)
  {
     super(name);
  }
