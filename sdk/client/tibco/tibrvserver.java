...
public class tibrvserver implements TibrvMsgCallback
{
    ...
    public void onMsg(TibrvListener listener, TibrvMsg msg)
    {
	    ...
	    System.out.println("listener.subject: " + listener.getSubject());

	    try {
		   reply_msg.setReplySubject(listener.getSubject());
		   transport.sendReply(reply_msg, msg);
	    } catch (TibrvException e) {
	         System.err.println("sendReply failed:" + e);
			e.printStackTrace();
	    } 
    ...
    void usage()
    {
        System.err.println("Usage: java tibrvserver [-service service] [-network network] [-daemon daemon]");
        System.exit(-1);
    }
